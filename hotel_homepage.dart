...
class hotelhomepagestate extends State<hotelhomepage>{
  final ref = FirebaseFirestore.instance.collection("ResturentDetail");
  final CollectionReference ref1 = FirebaseFirestore.instance.collection("user-file");
      ...
      body: Stack(
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream: ref1
                .where("Resturent", isEqualTo: widget.hotelname)
                .snapshots(),
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => DetailPage(
                            ...
                            itemDesc: itemDesc,
                            itemPrice: itemPrice,
                            resturentname: widget.hotelname,
                          ),
                        ),
                      );
                    },
